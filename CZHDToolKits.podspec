...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/CZHDToolKits"
  ...
  s.source       = { :git => "https://github.com/appledev201888/CZHDToolKits.git", :tag => "#{s.version}" }
  ...
  s.vendored_libraries = '**/DebugIQKeyboardTools.a'
